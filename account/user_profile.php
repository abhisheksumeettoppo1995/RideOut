...
if ($gClient->getAccessToken()) {
    ...
    <table border="5" align="center" style="border-color:orange">
        ...
        <tr>
            <!--td align="center"><!-?php echo '<button><a href="'.$userData['link'].'" target="_blank">Google+</button>'?></td-->
            <td align="center" colspan="4"><?php echo '<button><a href="../logout.php"> Logout </a></button>'?>
            <button><a href="login_panal.php"> Back </a></button></td>
        </tr>
    </table>
    <?php
